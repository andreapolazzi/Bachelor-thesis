...
derive_from_cancer_type <- function(x) {
  case_when(
    ...
    str_detect(x, regex("carcinoma|adenocarcinoma|lymphoma|myeloma|leukemia|mesothelioma|glioma|glioblastoma|blastoma|astrocytoma|oligodendro|neuroendocrine|paraganglioma|pheochromocytoma|cholangiocarcinoma|hepatocellular|urothelial", ignore_case = TRUE)) ~ "Carcinoma",
